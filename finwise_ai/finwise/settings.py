"""
Django settings for finwise_ai project.
...
# Use SQLite for a turnkey, ready-to-run package
DATABASES = {
    'default': {
...
# DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@finwiseai.com')
